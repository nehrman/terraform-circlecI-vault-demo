...
<img width="600" alt="CircleCI Pipeline Screenshot" src="https://github.com/nehrman/terraform-azure-windows/blob/master/images/CircleCI_workflow.png">
...
<img width="500" alt="CircleCI Pipeline Screenshot" src="https://github.com/nehrman/terraform-azure-windows/blob/master/images/Vault_CircleCi_Config.png">
...
```
4. *Sign up for a Terraform Cloud Trial* - Next we'll need a Terraform Cloud trial account. Sign up here: https://www.hashicorp.com/go/terraform-enterprise-trial
Log onto your new account here: https://app.terraform.io and follow the [guide](https://www.terraform.io/docs/enterprise/getting-started/index.html) to:
...
<img width="100" alt="CircleCI Pipeline Screenshot" src="https://github.com/nehrman/terraform-azure-windows/blob/master/images/CircleCI_add_project.png">
- Select your project and click on `Set Up Project`
<img width="100" alt="CircleCI Pipeline Screenshot" src="https://github.com/nehrman/terraform-azure-windows/blob/master/images/CircleCI_setup_project.png">
- Finally, configure the environment variables in your project 
<img width="600" alt="CircleCI Pipeline Screenshot" src="https://github.com/nehrman/terraform-azure-windows/blob/master/images/CircleCI_envvar.png">
