...
New-NetFirewallRule -Name "ConsulTCP" -DisplayName "Nomad UDP ports (4000-5000)" -Profile Domain,Private,Public -Enabled True -Protocol UDP -LocalPort 4000-5000 -Action Allow 
