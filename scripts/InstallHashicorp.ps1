...
Start-BitsTransfer -Source https://releases.hashicorp.com/consul/1.4.4+ent/consul_1.4.4+ent_windows_amd64.zip -Destination C:\Users\$env:username\Downloads\consul_1.4.4+ent_windows_amd64.zip
